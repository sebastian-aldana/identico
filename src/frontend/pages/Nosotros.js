      ...
      <div class="row justify-content-center">
        <div class="col-11 cAzulM py-3 mt-5 text-justify">
          <p>
            ...
            identificación segura y eficiente utilizando las mejores
            tecnologías, se remonta al año 1988 en Colombia (Sudamérica), los
            accionistas fundadores de la empresa en ese país, con vínculos
            mexicanos deciden emprender nuevos negocios en Ciudad de México.
          </p>
          <p>
        ...
        <div class="col-11 mb-5 text-justify">
          ...
          >
            ...
            <div class="col-md-8 col-lg-10 cAzulM align-self-center">
              ...
              <p>
                Es la capacidad de dar respuesta ante una obligación, función,
                rol o actividad asignada o asumida. Cumplir de una forma
                eficiente y eficaz con el compromiso adquirido.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="col-md-8 col-lg-10 cAzulM align-self-center">
              ...
              <ul>
                <li>
                  Observar constantemente comportamientos éticos y morales.
                </li>
            ...
            <div class="col-md-8 col-lg-10 cAzulM align-self-center">
              ...
              <ul>
                <li>
                  ...
                  convicción de brindar lo mejor de sí, con alto sentido del
                  deber social.
                </li>
                <span id="contacto" />
              </ul>
